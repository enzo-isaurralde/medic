...
public class MedicoController {
    ...
    @Transactional
    @PostMapping
    public ResponseEntity registrar(@RequestBody @Valid DTOMedic datos, UriComponentsBuilder uriComponentsBuilder){
    ...
    @Transactional
    @PutMapping
    public ResponseEntity actualizar(@RequestBody @Valid DTOActualizacionMedicos datos){
